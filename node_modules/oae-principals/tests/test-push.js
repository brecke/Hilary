    ...
    describe('Notifications', function() {
        ...
        it('verify visibility updates trigger a push notification', function(callback) {
            setupFixture(function(contexts, group, client) {
                ...
                client.on('message', function(message) {
                    // we might have been too fast getting to this point.. if that's the case, we might get the group creation notification before the group update one. So let's discard the former if we get it
                    if(_.first(message.activities)['oae:activityType'] === PrincipalsConstants.activity.ACTIVITY_GROUP_CREATE) {
